...
def main(argv):
    twitch_vod_m3u8 = TwitchVodm3u8()
    usage_message = 'twitch_vod_m3u8.py -u <userid> -q <quality>'

    try:
        opts, args = getopt.getopt(argv,"hu:q:",["userid=","quality="])
    ...
    for opt, arg in opts:
        if opt == '-h':
            ...
            twitch_vod_m3u8.user_id = arg
        elif opt in ("-q", "--quality"):
            twitch_vod_m3u8.quality = arg
